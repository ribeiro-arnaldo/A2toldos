...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.erro || 'Erro ao fazer login. Verifique suas credenciais.';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center mb-8">
          <img src={logoA2Toldos} alt="Logo A2 Toldos" className="w-48 mx-auto" />
          <h1 className="text-2xl font-bold text-brand-blue mt-4">Acesso ao Sistema</h1>
        </div>
